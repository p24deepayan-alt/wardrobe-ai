...
const ItemCard: React.FC<ItemCardProps> = ({ item, onClick }) => {
  return (
    <button
      ...
      className="group relative overflow-hidden rounded-lg shadow-lg bg-card border border-border/50 transition-all duration-300 hover:shadow-primary/20 hover:border-border focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background w-full text-left"
    >
